...
const JormForm = () => {
  return (
    <>
       <div className="max-w-[30rem]  mx-auto flex-col mt-24 flex  ">
         <h4 ></h4>
         <form className='mx-auto max-w-[800px] shadow-md shadow-slate-300 space-y-8 px-[90px] '>
            ...
            <label htmlFor='name' className="text-xl font-bold mt-6">Personal Information</label>
                ...
                <input 
                    type="password" 
                     ...
                     className='w-[30rem]  px-4 border-gray-400 mt-6 border-2 ml-[-1.6rem] mr-[-1.6rem] rounded-lg h-16' />
                  ...
                  <label htmlFor='name' className="text-xl font-bold mt-6">Account Security</label>
                     ...
                     className='w-[30rem]  px-[16px] ml-[-1.6rem] mt-6 mr-[-1.6rem] border-gray-400 border-2 rounded-lg h-16 ' />
                     <span className='text-sm font-semibold mr-[20%] text-gray-500'>This will be your username</span>
                   <input 
                    type="password" 
                     placeholder='*Password' 
                     className='w-[30rem]  px-4 border-gray-400 mt-6 border-2 ml-[-1.6rem] mr-[-1.6rem] rounded-lg h-16' />
                     <span className='text-sm font-semibold w-[28rem] text-gray-500'>Create a password 8 to 25 characters long that includes at least 1 uppercase and 1 lowercase letter, 1 number and 1 special character like an exclamation point or asterisk.</span>
                  </div>
                
               <div className='flex flex-col items-center mt-16'>
                <span className='text-[#00a862] font-bold text-sm underline mb-7'>Already have a Starbucks gift card?</span>
                <span className='text-sm text-[#00000094] leading-[.1em] uppercase font-bold mb-[2.4rem]'>COLLECT MORE STARS & EARN REWARDS</span>
