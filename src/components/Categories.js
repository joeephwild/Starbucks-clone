...
const Categories = () => {
  return (
    <div className='w-full  h[100vh] space-y-7 overflow-x-hidden'>
        <div className="md:flex block  md:py-9 md:pl-7 md:space-x-10 md:bg-[#fc81bf] mt-6 ">
        <div className='bg-[#fc75b8] md:ml-12 flex flex-col items-center'>
        ...
        <img src={banner2} alt="banner" className='md:w-[460px] object-contain'/>
    </div>
    </div>
  )
}
